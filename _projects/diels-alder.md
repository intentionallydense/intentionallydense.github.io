...
date: 2025-12-19
---
The reaction between acrylonitrile and cyclopentadiene (reaction B1 in Loco et al., 2022) was selected as a sort of proof-of-concept that my setup was actually capable of running the relevant computations. One of the combinations benchmarked and recommended by the paper is the ωB97XD functional with a 6-31G basis set because it's cheap and accurate. I used the ωB97X with D3BJ dispersion instead (yes, they are different methods...) with the same basis set because ORCA doesn't provide the ωB97XD functional.

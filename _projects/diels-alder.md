...
Transition state optimisation run 1: Maximum cycles reached, result was similar to product
Relaxed surface scan run 1: Unclear what went wrong but energy at 1.8A should not be higher than the transition state.

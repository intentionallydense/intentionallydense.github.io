...
![mean nudge curves across all 3 models](/assets/images/ucot-plot_model_comparison.png)
...
![same curves with IQR shaded bands](/assets/images/ucot-plot_nudge_curves_with_bands.png)
...
![per-problem distribution of final cue_p](/assets/images/ucot-plot_final_cue_p_distribution.png)
...
![per-problem nudge curves: 1.5B vs Qwen3 side by side](/assets/images/ucot-plot_nudge_curves_per_problem.png)
...
![per-problem 14B vs 1.5B/Qwen3 final cue_p](/assets/images/ucot-plot_per_problem_scatter.png)
...
![hinted vs correct CoT curves: 1.5B and Qwen3 side by side](/assets/images/ucot-plot_hinted_vs_correct_curves.png)

### Per-problem asymmetries

The per-problem scatter makes the contrast between the two small models more visible:

![per-problem hinted vs correct scatter: 1.5B and Qwen3](/assets/images/ucot-plot_content_symmetry_both.png)
...
![Qwen3 content-symmetry scatter, colored by population](/assets/images/ucot-plot_qwen3_populations.png)
...
### 2. Qwen3 main CSV has a regex-induced undercounting bias
...
### 3. The problem corpus is 14B-selected
...
### 4. Problem set overlap with the paper
...
### 5. Prompt format differs from paper
...
### 6. Extraction failures cluster by problem
...
![extraction failure rate per problem](/assets/images/ucot-plot_extraction_failures.png)

### 7. Temperature mismatch with Qwen3 recommendation
